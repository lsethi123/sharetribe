...
module Kassi
  class Application < Rails::Application
    ...
    config.assets.precompile += ['markerclusterer.js', 'communities/custom-style-*', 'ss-*', 'modernizr.min.js', 'mercury.js','jquery-1.7.js', 'custom.css', 'slider.css', 'responsive.css']
